...
<link
	...
	rel='stylesheet' type='text/css' />
<script src="<%=application.getContextPath()%>/libs/jquery/dist/jquery.min.js"></script>
<script src="<%=application.getContextPath()%>/libs/bootstrap/dist/js/bootstrap.min.js"></script>
<script src="<%=application.getContextPath()%>/customer/custom/js/login.js"></script>
